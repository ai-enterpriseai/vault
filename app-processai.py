...
class VaultApp:
    ...
    def set_page_config(self) -> None:
        ...
        """
        try:
            st.set_page_config(page_title="ProcessAI - LLM for Business", page_icon=":speech_balloon:", layout="wide")
    ...
    def show_sidebar(self) -> str:
        ...
        try:
            st.sidebar.title("ProcessAI-App")
            st.sidebar.text("Explore ProcessAI knowledge base")
